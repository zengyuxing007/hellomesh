...
import (
	...
	mcore "github.com/zengyuxing007/hellomesh/src/core"
...
func NewXDSServer(inventory mcore.InventoryService, vb mcore.VersionGenerator, conf model.HelloMeshConf, ctx context.Context, logger *logrus.Logger) XDSServer {
	return &xdss{
		inventory:     inventory,
